var Video_list = [
    {
        heading:"Maximal extractable value(MEV)",
        desc:"The discussion focuses on MEV which is the total value that miners, without the users' permission, extract from the Ethereum network by rearranging, adding, and censoring transactions within the blocks that are being generated. You’ll also get some insights on the tools used.",
        link:""
    },
    {
    ...
    },
    {
        ...
        desc:"This talk focussed on the fundamentals of decentralized finance and outlined how a new economic system based on peer-to-peer technology and self-executing smart contracts can be created and implemented using the Ethereum blockchain.",
        link:"https://youtu.be/BhtHZ8Iao3I"
    }
